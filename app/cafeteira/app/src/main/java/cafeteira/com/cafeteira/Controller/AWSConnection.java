...
public class AWSConnection {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a3ia6ywt1k1290.iot.us-west-2.amazonaws.com";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    //us-west-2:a5152ac4-1f33-44ec-a398-b27f9e310d2e
    private static final String COGNITO_POOL_ID = "us-west-2:a5152ac4-1f33-44ec-a398-b27f9e310d2e";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "COFFEE_MACHINE_QTT-Policy";
