...
print("[auth_web]: Ready goto http://{}:5050 or http://localhost:5050  to begin the auth process".format(ip))
print("[auth_web]: (Press Ctrl-C (or close this window on Windows) to exit this script once authorization is complete)")
